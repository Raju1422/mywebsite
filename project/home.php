...
FOR EACH OUTCOMES THERE IS A AVERAGE OF 960,000$ PLACED ON THEM.
...
<div background-color:blue;> 
  <br> 
  <br> 
  <center><h1 style="color:white; background-color:black;font-family:Courier New,monospace;font-weight:bold;"><b>PREDICTIONS</b></h1></center> 
  <br>
</div>
  <br> 
    <div>      
      ...
      if($team2-> num_rows > 0){  
        while($row = $team2-> fetch_assoc()){   
          ...
          echo"<div class='ab' style =' display:flex;white-space:no-wrap justify-content:center; align-items:center;'>";  echo"<td style='min-height:100px; box-sizing:border-box; padding:30px; padding-top:0px; padding-left:0px; padding-right:60px;padding-bottom:0px;border:3px dotted black;'>"; echo "<b>";echo $row["Gametype"];echo "</b>";echo "<br>";  echo"</div>";
          echo"<div class='ab'style =' display:flex; justify-content:center; align-items:center;'>";  echo $row["Team1"]; echo"&nbsp;";  echo"vs";echo"&nbsp;";   echo $row["Team2"];echo"</td>";  
 echo "</div>";  
 echo"</div>";
                    }
    }  
